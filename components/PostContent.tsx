    ...
    <div className="text-text w-full overflow-hidden">
      {isHTML ? (
        <div 
          ...
          className="prose prose-lg prose-neutral max-w-none w-full overflow-hidden [&_p]:mb-6 [&_p]:leading-7 [&_p]:text-base [&_h1]:text-4xl [&_h1]:font-bold [&_h1]:mb-6 [&_h1]:mt-10 [&_h1]:leading-tight [&_h2]:text-3xl [&_h2]:font-bold [&_h2]:mb-4 [&_h2]:mt-8 [&_h2]:leading-tight [&_h3]:text-2xl [&_h3]:font-bold [&_h3]:mb-3 [&_h3]:mt-6 [&_h3]:leading-tight [&_ul]:list-disc [&_ul]:ml-6 [&_ul]:mb-6 [&_ol]:list-decimal [&_ol]:ml-6 [&_ol]:mb-6 [&_li]:mb-2 [&_li]:leading-7 [&_blockquote]:border-l-4 [&_blockquote]:border-primary [&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:my-6 [&_blockquote]:text-lg [&_code]:bg-neutral-100 [&_code]:px-2 [&_code]:py-1 [&_code]:rounded [&_code]:text-sm [&_code]:font-mono [&_pre]:bg-neutral-100 [&_pre]:p-6 [&_pre]:rounded-lg [&_pre]:overflow-x-auto [&_pre]:my-6 [&_pre]:border [&_pre]:border-neutral-200 [&_a]:text-primary [&_a]:underline [&_a]:hover:text-primary/80 [&_a]:transition-colors [&_img]:max-w-full [&_img]:w-full [&_img]:h-auto [&_img]:object-contain [&_img]:my-8 [&_img]:rounded-lg [&_img]:shadow-lg [&_img]:mx-auto [&_img]:block [&_img]:overflow-hidden [&_video]:max-w-full [&_video]:w-full [&_video]:h-auto [&_video]:object-contain [&_video]:my-8 [&_video]:rounded-lg [&_video]:shadow-lg [&_video]:mx-auto [&_video]:block [&_video]:overflow-hidden"
        />
      ) : (
